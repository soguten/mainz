...
async function assertLocalizedSeoOutput(args: {
  ...
  assertStringIncludes(rootHtml, '"routeRenderMode":"csr"');
  assertStringIncludes(rootHtml, '"documentRenderMode":"csr"');
  assertStringIncludes(rootHtml, '"generationRuntime":"build"');
}
