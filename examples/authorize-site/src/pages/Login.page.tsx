    ...
    return (
      ...
      >
        <section className="authorize-site-note">
          Anonymous visitors who type a protected route are redirected here
          through
          <span className="authorize-site-code">auth.loginPath</span>.
          Authenticated users keep the same login page available so you can
