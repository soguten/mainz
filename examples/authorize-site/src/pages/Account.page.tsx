        ...
        return (
            ...
            >
                <section className="authorize-site-card-grid">
                    ...
                    <article className="authorize-site-card">
                        ...
                        <p>
                            ...
                            <span className="authorize-site-code">filterVisibleRoutes()</span>.
                            Authenticated users see more routes, but only when the matching role or
                            policy passes.
                        </p>
                    </article>
                </section>
                ...
                <section className="authorize-site-panel authorize-site-owner-shell">
                    ...
                    <p>
                        The wrapper text is public to any authenticated user. The component below
                        owns a stricter rule and renders only when the principal carries the
