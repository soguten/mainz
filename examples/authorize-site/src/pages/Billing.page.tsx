        ...
        return (
            ...
            >
                <section className="authorize-site-card-grid">
                    <article className="authorize-site-card">
                        ...
                        <p>
                            ...
                            <span className="authorize-site-code">principal.claims.orgId</span>
                    ...
                    <article className="authorize-site-card">
                        ...
                        <p>
                            Role checks answer who the user is inside one org. Policies answer a
                            broader question that can depend on claims, tenancy, or host logic.
                        </p>
                    </article>
                </section>
                ...
                <section className="authorize-site-note">
                    ...
                    disappears from the nav because the same policy also drives visibility. Typing
                    the URL manually will still produce a runtime
