...
export function StoryFailureNotice(args: { error: unknown }) {
  ...
  return (
    <Card
      className="di-http-panel di-http-panel--error"
      data-state="error"
      variant="subtle"
    >
      ...
      <p>
        This panel intentionally asks the API for a missing story so the example
        can show an <span className="di-http-link">error()</span>{" "}
        lifecycle hook.
      </p>
