...
export class InputValueScenario
  extends Component<{}, { value: string; observed: string }> {
  ...
  override render() {
    return (
      <section className="card">
        ...
        <button type="button" onClick={this.syncServerValue}>
          Set state.value = server-next
        </button>
      </section>
    );
  }
