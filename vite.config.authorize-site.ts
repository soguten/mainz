...
const outputDir = process.env.MAINZ_OUT_DIR ?? `dist/examples/authorize-site/${renderMode}`;
...
export default defineConfig({
    ...
    define: {
        ...
        __MAINZ_TARGET_NAME__: JSON.stringify("authorize-site"),
