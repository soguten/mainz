...
export class IsolationSelectionSurface
  extends Component<{}, { selected: number | null }> {
  protected override initState() {
...
export class IsolationDraftSurface
  extends Component<{}, { value: string; validated: boolean }> {
  protected override initState() {
