...
export class FormHarnessComponent extends Component<{}, { text: string; choice: string }> {
...
export class ClickHarnessComponent extends Component<{}, { count: number }> {
    ...
    override render(): HTMLElement {
        return <button type="button" onClick={this.onClick}>{String(this.state.count)}</button>;
    }
}
