...
Deno.test("diagnostics/components/rules: typed render(data) without explicit Data should error", () => {
...
Deno.test("diagnostics/components/rules: render(data: unknown) without explicit Data should stay valid", () => {
  const diagnostics = componentRenderDataWithoutExplicitDataRule.run({
    file: "/repo/src/components/Panel.tsx",
    exportName: "Panel",
    isAbstract: false,
