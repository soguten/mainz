...
export async function buildDiagnosticsTargetModelsForTarget(
    ...
    return evaluations.map((evaluation) => {
        const discoveryDiagnostics = collectDiscoveryDiagnostics(evaluation.discoveryErrors);
...
function toRouteDiagnosticsPages(discoveredPages: readonly CliDiscoveredPage[]) {
