...
export const dynamicSsgMissingEntriesDiagnosticCode =
  "dynamic-ssg-missing-entries" as const;
...
export function collectDynamicSsgMissingEntriesDiagnostics(
  ...
  return [{
    ...
    severity: "error",
    message:
      `SSG route "${page.page.path}" must define entries() to expand dynamic params.`,
    file: page.file,
