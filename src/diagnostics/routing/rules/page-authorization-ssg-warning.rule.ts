...
export const pageAuthorizationSsgWarningDiagnosticCode = "page-authorization-ssg-warning" as const;
...
export function collectPageAuthorizationSsgDiagnostics(
    ...
    return [{
        ...
        severity: "warning",
        message: `Page "${page.exportName}" uses @Authorize(...) with @RenderMode("ssg"). ` +
