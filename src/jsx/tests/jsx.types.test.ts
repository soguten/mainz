...
const fixtures = await import("./jsx.types.fixture.tsx") as typeof import("./jsx.types.fixture.tsx");
...
Deno.test("jsx/types: should allow key on typed class and function components", () => {
    ...
    assertEquals(classNode.tagName, fixtures.NarrowPropsClassComponent.getTagName().toUpperCase());

    const classProps = (classNode as HTMLElement & { props: Record<string, unknown> }).props;
