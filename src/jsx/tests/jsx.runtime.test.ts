...
const runtime = await import(
  "../jsx-runtime.ts"
) as typeof import("../jsx-runtime.ts");
const fixtures = await import(
  "./jsx.runtime.fixture.tsx"
) as typeof import("./jsx.runtime.fixture.tsx");
...
Deno.test("jsx/runtime: jsxs should preserve array children for function components", () => {
  ...
  assertEquals(
    (fixtures.runtimeCapture.lastProps?.children as unknown[]).length,
    3,
  );
});
