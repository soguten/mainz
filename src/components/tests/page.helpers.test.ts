...
import { createPageLoadContext, load, Locales, Page, RenderMode } from "../index.ts";
import {
    isPageConstructor,
    resolvePageLocales,
...
Deno.test("components/page helpers: RenderMode should preserve explicit ssg fallback config", () => {
    ...
    assertEquals(resolvePageRenderConfig(FallbackPage), { mode: "ssg", fallback: "csr" });
});
...
Deno.test("components/page helpers: should read page metadata through shared symbols across package instances", () => {
    ...
    (ForeignCompatiblePage as unknown as Record<PropertyKey, unknown>)[Symbol.for("mainz.page.constructor")] = true;
    (ForeignCompatiblePage as unknown as Record<PropertyKey, unknown>)[Symbol.for("mainz.page.route-path")] = "/foreign";
    (ForeignCompatiblePage as unknown as Record<PropertyKey, unknown>)[Symbol.for("mainz.page.render-mode")] = {
        mode: "ssg",
        fallback: "csr",
    };
    (ForeignCompatiblePage as unknown as Record<PropertyKey, unknown>)[Symbol.for("mainz.page.locales")] = ["en", "pt-BR"];
    ...
    assertEquals(resolvePageRenderConfig(ForeignCompatiblePage), { mode: "ssg", fallback: "csr" });
