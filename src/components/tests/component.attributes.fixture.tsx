...
export class AddAttrOnRenderComponent extends Component<{}, { active: boolean }> {
    protected override initState() {
        return { active: false };
    }
...
export class RemoveAttrOnRenderComponent extends Component<{}, { active: boolean }> {
    protected override initState() {
        return { active: true };
    }
...
export class UpdateAttrValueComponent extends Component<{}, { status: string }> {
    protected override initState() {
        return { status: "idle" };
    }
...
export class MissingAttrComponent extends Component<{}, { role: string | null }> {
    protected override initState() {
        return {
            role: this.getAttribute("data-role"),
        };
