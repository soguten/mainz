...
const fixtures = await import("./component.state-override.fixture.tsx") as typeof import("./component.state-override.fixture.tsx");
...
Deno.test("stateOverride: should be reflected in the very first render after merge", () => {
    ...
    const screen = renderMainzComponent(fixtures.FirstRenderMergedStateComponent, {
        stateOverride: {
            visible: true,
        },
    });
