...
export class PropsInitialStateComponent
  extends Component<{ initial?: number }, { count: number }> {
  renderCalls = 0;
...
export class NoBootstrapRenderComponent
  extends Component<{}, { ready: boolean }> {
  renderCalls = 0;
  mountCalls = 0;
...
export class StateOverrideComponent
  extends Component<{ initial?: number }, { count: number }> {
  initCalls = 0;
