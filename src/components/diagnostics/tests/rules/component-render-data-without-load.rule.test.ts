...
Deno.test("components/diagnostics/rules: render(data) without load should error", () => {
    ...
    assertEquals(diagnostics, [{
        ...
        severity: "error",
        message: 'Component "Panel" declares render(data) but does not declare load(). ' +
...
Deno.test("components/diagnostics/rules: render(data) with load should stay valid", () => {
    const diagnostics = componentRenderDataWithoutLoadRule.run({
        file: "/repo/src/components/Panel.tsx",
        exportName: "Panel",
        isAbstract: false,
