...
class LeftRoot extends Component {
  override render() {
    return (
      <button
        ref={(element: Element) => leftButton = element as HTMLButtonElement}
      >
        Left
      </button>
    );
...
class RightRoot extends Component {
  override render() {
    return (
      <button
        ref={(element: Element) => rightButton = element as HTMLButtonElement}
      >
        Right
      </button>
    );
  ...
  override render() {
    return (
      <>
        <button
          ref={(element: Element) =>
            guardedButton = element as HTMLButtonElement}
        >
          Guarded
        </button>
        <button
