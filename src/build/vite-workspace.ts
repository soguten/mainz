...
export function resolveGeneratedViteConfigArtifactDir(args: {
    ...
    return resolveMainzTempPath(args.cwd, "vite-configs", args.targetName, args.runtimeName);
}
...
async function fileExists(path: string, runtime: MainzToolingRuntime): Promise<boolean> {
    try {
