import { isDynamicRoutePath, validateRouteEntryParams } from "../../index.ts";
import type {
    MainzDiagnostic,
...
export const dynamicSsgInvalidEntriesDiagnosticCode = "dynamic-ssg-invalid-entries" as const;
...
export function collectDynamicSsgInvalidEntriesDiagnostics(
    ...
    return collectArrayEntriesDiagnostics(page, entriesEvaluation, locales, diagnostics);
}
