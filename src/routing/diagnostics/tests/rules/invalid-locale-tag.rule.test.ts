...
Deno.test("routing/diagnostics/rules: invalid locale rule should ignore valid locale tags", () => {
...
Deno.test("routing/diagnostics/rules: invalid locale rule should report invalid locale tags", () => {
    const diagnostics = collectInvalidLocaleTagDiagnostics({
        file: "/repo/src/pages/Home.page.tsx",
        exportName: "HomePage",
        page: {
