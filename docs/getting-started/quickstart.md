...
A page only needs a route annotation, optional locale metadata, optional page metadata, and a render method. The framework takes care of registration and head management.
